...
<script>
 ...
 if ($_SESSION['user_name'] == "Guests"  || $_SESSION['user_name'] == "") echo "<p style=\"text-align:center;color:red;\"><u><b>You are not logged in!</b></u></p>";
 else  echo "<p style=\"text-align: center;\"><b>Playing as: " . $_SESSION['user_name'] . "</b></p>";
  try {
  $con= new PDO("mysql:host=$hostname;dbname=$database", "$username", "$password");
  $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  $query = "SELECT Username, Rush FROM leaderboard ORDER BY Rush DESC";
  print "<table>";
